...
function AccountPurchaseDeadlineTab() {
  ...
  const columns = useMemo(
    () => [
      ...
      { header: "구분", accessorKey: "category", size: 80 },
      { header: "구매처", accessorKey: "vendor", size: 180 },
      { header: "비과세", accessorKey: "tax_exemption", size: 80 },
      { header: "공급가", accessorKey: "supply", size: 80 },
      { header: "부가세", accessorKey: "vat", size: 80 },
      { header: "합계", accessorKey: "total", size: 80 },
      { header: "요청일", accessorKey: "total", size: 80 },
      { header: "지급일", accessorKey: "total", size: 80 },
      { header: "증빙자료사진", accessorKey: "proof", size: 200 },
      { header: "발행일자", accessorKey: "note", size: 100 },
    ],
    []
  );
